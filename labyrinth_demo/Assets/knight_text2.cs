...
public class knight_text2 : MonoBehaviour
{
    ...
    public GameObject knight_text; // Reference to the chatbox GameObject.

    private bool chatActive = false;

    void Start()
    {
        knight_text.SetActive(false);
    }
